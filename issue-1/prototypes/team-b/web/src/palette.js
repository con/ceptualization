// One palette object per theme. CSS variables drive the chrome; cytoscape
// needs real colour strings, so the two are kept in sync here by hand.
export const PALETTES = {
  dark: {
    ...
    edge: '#5a6472', edgeText: '#c9d1d9', edgeLabelBg: '#0d1117',
  ...
  light: {
    ...
    edge: '#8c959f', edgeText: '#24292f', edgeLabelBg: '#ffffff',
